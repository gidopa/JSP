...
<%--결제하기 버튼을 누르면 결제후 예약 요청 --%>
	...
	<div align="center">	
		...
		<p>
			회원 아이디 : <input type="text" name="memberid" value="${requestScope.membervo.id }" readonly>
			&nbsp;&nbsp;&nbsp;
			회원 비밀번호 : <input type="password" name="memberpass" value="${requestScope.membervo.pass}" readonly>
